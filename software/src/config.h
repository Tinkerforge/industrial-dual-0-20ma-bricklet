 ...
 *
 * config.h: Industrial Dual 0-20mA Bricklet specific configuration
 *
...
#define BRICKLET_DEVICE_IDENTIFIER 228
...
#define PIN_MEASURE (BS->pin1_ad)
#define PIN_SELECT  (BS->pin2_da)
