...
int main() {
	...
	industrial_dual_0_20_ma_set_debounce_period(&dual020, 10000);

	// Register threshold reached callback to function cb_reached
	industrial_dual_0_20_ma_register_callback(&dual020,
	                                          INDUSTRIAL_DUAL_0_20_MA_CALLBACK_CURRENT_REACHED,
	                                          (void *)cb_reached,
	                                          NULL);

	// Configure threshold (sensor 1) for "greater than 10mA" (unit is nA)
	industrial_dual_0_20_ma_set_current_callback_threshold(&dual020, 1, '>', 10*1000*1000, 0);
